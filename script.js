...
function updateCarList() {
  ...
  if (carList && carList.length > 0) {
    carList.forEach(function(car, index) {
      ...
      carItem.innerHTML = '<div class="child" style="width: 100%"><strong>' + car.name + '</strong> - Last Maintenance: ' + car.lastMaintenanceDate + ' - Next Maintenance in ' + daysRemaining + ' days </div>';
